...
CONSUMED_HEATING_TODAY = "consumed_energy_today"
CONSUMED_HEATING_TOTAL = "consumed_energy_total"
CONSUMED_WATER_HEATING_TODAY = "consumed_water_energy_today"
CONSUMED_WATER_HEATING_TOTAL = "consumed_water_energy_total"
