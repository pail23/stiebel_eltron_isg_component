...
WPM_SYSTEM_STATE_REGISTERS = {
    ...
    WpmSystemStateRegisters.BUS_STATUS: ModbusRegister(
        address=2505,
        name="BUS STATUS",
        unit="",
        min=-4.0,
        max=0.0,
        data_type=6,
        key=WpmSystemStateRegisters.BUS_STATUS,
    ),
    WpmSystemStateRegisters.DEFROST_INITIATED: ModbusRegister(
        address=2506,
        ...
        max=1.0,
        data_type=6,
        key=WpmSystemStateRegisters.DEFROST_INITIATED,
    ),
    WpmSystemStateRegisters.ACTIVE_ERROR: ModbusRegister(
        address=2507,
        name="ACTIVE ERROR",
        unit="",
        min=0.0,
        max=65535.0,
        data_type=6,
        key=WpmSystemStateRegisters.ACTIVE_ERROR,
    ),
    WpmSystemStateRegisters.MESSAGE_NUMBER: ModbusRegister(
        address=2508,
        name="MESSAGE NUMBER",
        unit="",
        min=0.0,
        max=65535.0,
        data_type=6,
        key=WpmSystemStateRegisters.MESSAGE_NUMBER,
    ),
}
...
WPM_ENERGY_MANAGEMENT_SETTINGS_REGISTERS = {
    WpmEnergyManagementSettingsRegisters.SWITCH_SG_READY_ON_AND_OFF: ModbusRegister(
        address=4001,
        name="SWITCH SG READY ON AND OFF",
        unit="",
        min=0.0,
        max=1.0,
        data_type=6,
        key=WpmEnergyManagementSettingsRegisters.SWITCH_SG_READY_ON_AND_OFF,
    ),
        ...
        super().__init__(
            [
                ...
                ModbusRegisterBlock(
                    ...
                    registers=ENERGY_SYSTEM_INFORMATION_REGISTERS,
                    register_type=RegisterType.INPUT_REGISTER,
                ),
            ],
            host,
