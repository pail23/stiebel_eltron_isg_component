...
| Capability-matrix design | Maintainer agreement before generator or model gates | Evidence model plus a concrete writable-capability pilot; no runtime or entity-identity change | `codex/design-capability-matrix` at `a955eca`; review corrections and diff validation complete |
